...
import UIKit
  ...
  extension UIViewController{
    ...
    func gradientColor(){
        ...
        func gradientTable(tableview:UITableView)
        
        {
            ...
            gradient.startPoint = CGPoint(x: 1.0, y: 0.0)
            gradient.endPoint = CGPoint(x: 1.0, y: 1.0)
           // gradient.frame = CGRect(x: 0.0, y: 0.0, width: tableview.backgroundView?.frame.size.width, height:tableview.backgroundView?.frame.size.height)
